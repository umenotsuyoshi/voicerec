...
class voice_save extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventvoicesave', 'voicerec');
    }
	public function get_description() {
	    return "The user with id {$this->userid} save recorded voice in the category with id {$this->objectid} in the voicerec with course module id {$this->contextinstanceid}.";
    }
